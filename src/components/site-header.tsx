...
const mainNavLinks = [
    { href: '/produk', label: 'Templates' },
    { href: '/dukungan', label: 'Support' },
];
    ...
    <header className="sticky top-0 z-50 w-full border-b border-border/40 bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60">
      <div className="container flex h-16 max-w-screen-xl items-center justify-between">
        <Link href="/" className="flex items-center gap-2" prefetch={false}>
          ...
          <span className="font-headline text-2xl font-bold text-foreground">DesignBloom</span>
        </Link>
            ...
            <SheetContent side="right" className="w-full max-w-sm">
                <SheetHeader>
                  ...
                  <SheetDescription className="sr-only">
                    Main navigation for DesignBloom. Browse templates or contact support.
                  </SheetDescription>
                </SheetHeader>
